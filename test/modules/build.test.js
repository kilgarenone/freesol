...
describe('build', function () {
  it('should empty output path', function () {
    // given
    fs.mkdirsSync(mockConfig.build.outputPath);
  ...
  it('should copy assets folder', function () {
    ...
    // then
    expect(fs.existsSync(`${mockConfig.build.outputPath}/asset.txt`)).to.be
      .true;
    expect(fs.existsSync(`${mockConfig.build.outputPath}/sub/another.txt`)).to
      .be.true;
  });
  ...
  it('should not generate extra directory if filename is index', function () {
    ...
    expect(
      fs.existsSync(`${mockConfig.build.outputPath}/with-index/index.html`)
    ).to.be.true;
  });
